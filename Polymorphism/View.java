...
class View extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		for (int i = 0; i < model.items.size(); i++) {
			...
			// g.drawImage(image, (p.x - w / 2) - this.horScroll, (p.y - h) - this.vertScroll, null);
			g.drawImage(image, dx1, dy1, dx1 + sw, dy1 + sh, 0, 0, w, h, null);
