...
//     Submarine(Json ob)
//     {
//         this.atomic = ob.getBool("atomic");
//         this.crewSize = ob.getInt("crewSize");
//         this.depth = ob.getDouble("depth");
//         this.peri = new Periscope(ob.get("peri"));
//         this.ammo = new ArrayList<Torpedo>();
//         Json tmpList = ob.get("ammo");
//         for(int i = 0; i < tmpList.size(); i++)
//             this.ammo.add(new Torpedo(tmpList.get(i)));
//     }
//
//
...
//         ob.add("atomic", this.atomic);
//         ob.add("crewSize", this.crewSize);
//         ob.add("depth", this.depth);
//         ob.add("peri", this.peri.marshal());
//         Json tmpList = Json.newList();
//         ob.add("ammo", tmpList);
//         for(int i = 0; i < ammo.size(); i++)
//             tmpList.add(this.ammo.get(i).marshal());
//         return ob;
//     }
// }
//
